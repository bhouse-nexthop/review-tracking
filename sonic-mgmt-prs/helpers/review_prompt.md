...
```
### PR #<N> — <title>
- **Author / affiliation / trust:** <login> / <affiliation> / <Expert|High|Medium|Low|Unproven — from `sweep.py --trust <login>`: merged-PR history + major-company (score>1500) bump (capped at High; Expert is individual-only)>
